...
# DVE full session
# Saved on Wed Feb 19 16:04:46 2020
# Designs open: 1
...
gui_sg_addsignal -group "$_session_group_1" { TOP.ag_we TOP.ag_csw TOP.ag_dval TOP.ag_modrm TOP.ag_eipw TOP.dval TOP.sval TOP.disp TOP.eip TOP.cc TOP.ccw TOP.sreg TOP.ptr TOP.clk TOP.we TOP.re TOP.ag_e TOP.v TOP.rmsel TOP.eipw TOP.csw TOP.alusel TOP.modrm TOP.ag_re TOP.ag_v TOP.ag_rmsel TOP.ag_alusel TOP.ag_sval TOP.ag_disp TOP.mr_addrin TOP.ag_cc TOP.ag_ccw TOP.ag_sreg TOP.ag_ptr TOP.mr_re TOP.mr_we TOP.mr_v TOP.mr_rmsel TOP.mr_eipw TOP.mr_csw TOP.read_finished TOP.write_finished TOP.re_temp TOP.ex_vin TOP.mr_reb TOP.mr_addr TOP.mr_dval TOP.mr_sval TOP.mem_val TOP.ex_dvalin TOP.ex_svalin TOP.mr_cc TOP.mr_ccw TOP.mr_ptr TOP.mr_modrm TOP.mr_alusel TOP.ex_we TOP.ex_v TOP.ex_rmsel TOP.ex_eipw TOP.ex_csw TOP.mw_cfin TOP.mw_afin TOP.mw_ofin TOP.ex_addr TOP.ex_dval TOP.ex_sval TOP.ex_cc TOP.ex_ccw TOP.mw_aluvalin TOP.ex_ptr TOP.ex_modrm TOP.ex_alusel TOP.mw_we TOP.mw_cf TOP.mw_af TOP.mw_of TOP.mw_v TOP.mw_eipw TOP.mw_csw TOP.mw_rmsel TOP.rfwe TOP.mwe TOP.mw_aluval TOP.mw_cc TOP.mw_ccw TOP.mw_addr TOP.cc_temp TOP.mw_ptr TOP.mw_modrm TOP.wreg TOP.CYCLE_TIME }
gui_set_radix -radix {decimal} -signals {V1:TOP.CYCLE_TIME}
gui_set_radix -radix {twosComplement} -signals {V1:TOP.CYCLE_TIME}
